...
Rationale:
First dynamic programming exercise. This solution starts at the bottom and 
works its way up calculating the largest of each possibility. Very simple and
...
def problem_18(triangle=TRIANGLE):
